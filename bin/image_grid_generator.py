...
# new version - classes showcase 
columns = 5
rows = 7
files = ['10', '20', '30', '40', '50', '60', '70', '71', '80', '90', '91', '100', '101', '110', '120', '130', '140', '141', '150', '151', '160', '170', '171', '180', '181', '190', '200', '210', '220', '230', '240']
count = ['394','80','808','355','302','395','506','383','524','408','346', '974', '325', '314', '798', '307',  '86', '359',  '31', '433', '305', '105', '168', '104', '404', '493', '383', '231',  '26', '202',  '56']
...
for index in range(len(files)):
    ...
    x_text_offset = x_offset - 10 + int(image_width/2.0)
    y_text_offset = y_offset + 225 + 31
