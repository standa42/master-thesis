...
if __name__ == "__main__":
    ...
    model.add(tf.keras.layers.Conv2D(256, kernel_size=3, padding='same', activation='relu', input_shape=(256, 256,3)))
    ...
    model.add(tf.keras.layers.Conv2D(3, kernel_size=3, padding='same', activation='relu'))
